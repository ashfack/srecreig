        ...
        <ul class="nav navbar-top-links navbar-right">
            ...
            <li class="dropdown">
                <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                    <i class="fa fa-search fa-fw"></i>  <i class="fa fa-caret-down"><span class="infobulle">Rechercher</span></i>
                </a>
            ...
            ?>
                    <li class="dropdown">
                        <a class="dropdown-toggle" href="formulaireEntreprise.php">
                            <i class="fa fa-plus fa-fw"><span class="infobulle">Ajouter</span></i> 
                        </a>
                    </li>
            <?php    
                }
            ...
            ?>            
                    <li class="dropdown">
                        <a class="dropdown-toggle" href="exporter_critere.php">
                            <i class="glyphicon glyphicon-download"><span class="infobulle">Exporter</span></i> 
                        </a>
                    </li>
            <?php    
                }
            ...
            <li class="dropdown">
                <a class="dropdown-toggle" href="agenda.php">
                    <i class="fa fa-calendar fa-fw"><span class="infobulle">Agenda</span></i> 
                </a>
            </li>
            
            <li class="dropdown">
                <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                    <i class="fa fa-user fa-fw"></i>  <i class="fa fa-caret-down"><span class="infobulle">Profil</span></i>
                </a>
