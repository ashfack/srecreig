    ...
    $.ajax(
    {
        ...
        success: function(data) 
        {
            ...
            if (data.length > 0) 
            {
                ...
                $("#div_datatable").append("<div class=\"col-md-2\"></div><div class=\"col-md-8\"><center><button id='bInfo'> Voir les informations </button></div> <div class=\"col-md-2\"></div> ");
